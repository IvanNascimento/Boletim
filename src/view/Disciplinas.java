...
public class Disciplinas extends javax.swing.JInternalFrame {
  ...
  public Disciplinas(Usuario user, int userId) {
    initComponents();
    this.UserId = userId;
    this.User = user;
    this.disciplinas = User.getDados().getDisciplinas();
    this.Init(this.disciplinas);
  }
  ...
  private void AddDisciplinaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddDisciplinaActionPerformed
    ...
    this.User.getDados().addDisciplina(new Disciplina(NomeDisciplina.getText(), NomeProfessor.getText(), medias));
