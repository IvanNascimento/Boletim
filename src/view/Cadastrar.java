...
public class Cadastrar extends javax.swing.JDialog {
    ...
    private boolean isIn(String login){
      Dados dados = new Dados();
      ArrayList<Usuario> usuarios = dados.Carregar();
    ...
    private void cadastrar(){
      if(Arrays.equals(Password.getPassword(), PasswordConfirm.getPassword()) && isIn(this.UserName.getText()) == false){
        ...
        System.out.println("Senhas diferentes ou Usuario já em uso");
      }
    }
